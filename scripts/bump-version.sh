#!/usr/bin/env bash
# scripts/bump-version.sh — bump the mayfly version on merge to main.
...
GIT_USER="${BUMPVER_GIT_USER:-mayfly-release}"
GIT_EMAIL="${BUMPVER_GIT_EMAIL:-release@mayfly.local}"
